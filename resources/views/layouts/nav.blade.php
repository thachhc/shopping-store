        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="url(route('user.cart'))" :active="request()->routeIs('user.cart')">
                        {{ __('Cart') }}
                    </x-nav-link>
                    <x-nav-link href="/orderdetails" :active="request()->routeIs('user.order')">
                        {{ __('Order') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="Auth::user()->role == 'admin' ? url('/admin/dashboard') : url('/dashboard')">
                                {{ __('Dashboard') }}
                            </x-dropdown-link>
