...
<head>
    ...
    <title>Edit Size & Quantity</title>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('codesizes.updateByProduct', $productId) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" id="total_sizes" class="form-control" min="1" onchange="generateSizeInputs()" value="{{ count($sizes) }}" required>
            </div>
            ...
            <div id="size-quantity-container">
                ...
                <div class="form-group row align-items-center mb-2">
                    <div class="col-md-6 text-left">
                        <input type="text" name="size[]" class="form-control" value="{{ $size->sizenumber }}" placeholder="Size">
                    </div>
                    <div class="col-md-6 text-right">
                        <input type="number" name="quantity[]" class="form-control" value="{{ $size->quantity }}" min="1" placeholder="Số lượng">
                    </div>
                </div>
                @endforeach
            </div>
