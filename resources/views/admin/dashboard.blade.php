    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text mb-3">Add, edit, delete products.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text mb-3">Add, edit, delete categories.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text mb-3">Add, edit, delete brands.</p>
            ...
            <div class="col-md-4 mt-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h5 class="card-title mt-3">Manage Tags</h5>
                        <p class="card-text mb-3">Add, edit, delete tags.</p>
            ...
            <div class="col-md-4 mt-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text mb-3">Add, edit, delete orders.</p>
                        <a href="{{ route('tags.index') }}" class="btn btn-warning">Go to</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mt-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h5 class="card-title mt-3">Manage User</h5>
                        <p class="card-text mb-3">Add, edit, delete user.</p>
                        <a href="{{ route('tags.index') }}" class="btn btn-warning">Go to</a>
                    </div>
                </div>
            </div>
