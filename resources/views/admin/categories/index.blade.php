<x-app-layout>
    ...
    <div class="container mt-5">
        ...
        <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createCategoryModal"><i class="bi bi-plus"></i> Thêm Danh Mục Mới</button>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Form xóa danh mục -->
                        <form action="{{ route('categories.destroy', $category->id) }}" method="POST" style="display:inline;" onsubmit="confirmDelete(event)">
                            @csrf
                            @method('DELETE')
